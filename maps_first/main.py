...
regions = [
    {'name': 'maps_first//Africa.png', 'extent': [-20, 60, -40, 40]},  # Африка
    {'name': 'maps_first//Canada.png', 'extent': [-140, -50, 40, 85]},  # Канада
    {'name': 'maps_first//Japan', 'extent': [129, 146, 30, 46]},  # Япония
    {'name': 'maps_first//China', 'extent': [73, 135, 18, 54]},  # Китай
    {'name': 'maps_first//India', 'extent': [68, 90, 6, 37]}  # Индия
]
